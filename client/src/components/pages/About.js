...
const AboutUs = () => {
    return (
        <section id="about" className='bg-gray-400 text-white flex align-middle justify-center text-center'>
            <div className="px-lg-5 justify-center align-middle">
                {/* Heading */}
                <div className="position-relative d-flex text-center mb-5">
                    <h2 className="text-24 text-uppercase fw-600 w-100 mb-0 text-muted opacity-1 text-light opacity-4">
                        About Me
                    </h2>
                    <p className="text-9 text-dark fw-600 position-absolute w-100 align-self-center lh-base mb-0 text-white text-dark">
                        Know Me More
